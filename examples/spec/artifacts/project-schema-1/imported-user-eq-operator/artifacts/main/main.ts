...
export const main = (_unit: undefined) => _ssrg_console_println(render([((same(Ready)(Ready)(__ssrg$instance$Eq$0)) as boolean), ((different(Ready)(Waiting)(__ssrg$instance$Eq$0)) as boolean)] as const))

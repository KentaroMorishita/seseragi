...
export const main = (_unit: undefined) => (() => { const normalize: (argument: string) => string = ops_normalize; return (() => { const slice: (argument: string) => { readonly tag: "Left"; readonly value: TextSliceError } | { readonly tag: "Right"; readonly value: string } = ops_scalarSlice; return _ssrg_effect_flatMap(_ssrg_console_println(normalize(source)), () => _ssrg_effect_flatMap(_ssrg_console_println(_ssrg_show_eitherShow<TextSliceError, string>(_ssrg_textSliceErrorShow, _ssrg_show_stringShow)["show"](slice(source))), () => _ssrg_effect_flatMap(_ssrg_console_println(_ssrg_show_eitherShow<GraphemeSliceError, string>(_ssrg_graphemeSliceErrorShow, _ssrg_show_stringShow)["show"](ops_graphemeSlice(source))), () => _ssrg_effect_flatMap(_ssrg_console_println(_ssrg_show_maybeShow<string>(_ssrg_show_charShow)["show"](ops_character(128077)) + " / " + _ssrg_show_maybeShow<number>(_ssrg_show_intShow)["show"](_ssrg_maybe_functor["map"](ops_point)(ops_character(128077)))), () => _ssrg_console_println(ops_inspectError(_ssrg_text_InvalidScalarRange(({ "start": _ssrg_int_subtract(0, 1), "end": 2, "length": 5 } as const)))))))); })(); })()

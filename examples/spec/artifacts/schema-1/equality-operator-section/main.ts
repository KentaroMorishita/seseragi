...
export const main = (_unit: undefined) => _ssrg_console_println(render([applyComparison((_argument0) => (_argument1) => __ssrg$instance$Eq$0["eq"](_argument0)(_argument1))(Ready)(Ready), applyComparison((_argument0) => (_argument1) => __ssrg$instance$Eq$0["eq"](_argument0)(_argument1) === false)(Ready)(Waiting), applyIntComparison((_argument0) => (_argument1) => _ssrg_int_eq_dictionary["eq"](_argument0)(_argument1))(42)(42), applyIntComparison((_argument0) => (_argument1) => _ssrg_int_eq_dictionary["eq"](_argument0)(_argument1) === false)(42)(41), ((genericSame(Waiting)(Waiting)(__ssrg$instance$Eq$0)) as boolean)] as const))

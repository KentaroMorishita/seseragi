import { intOne as _ssrg_int_one, intMul as _ssrg_int_mul } from "@seseragi/runtime/int"
...
const productArray = (unit: undefined) => number(productValues([2, 3, 4])(_ssrg_array_reducible))
const productList = (unit: undefined) => number(productValues(_ssrg_list_from_array([2, 3, 4]))(_ssrg_list_reducible))
const productRange = (unit: undefined) => number(productValues(_ssrg_range_inclusive(1, 4))(_ssrg_range_reducible))
const productEmpty = (unit: undefined) => number(productValues(emptyValues(undefined))(_ssrg_array_reducible))
const anyArray = (unit: undefined) => yesNo(anyPositive([0, 0, 2])(_ssrg_array_iterable))
const anyList = (unit: undefined) => yesNo(anyPositive(_ssrg_list_from_array([0, 0, 0]))(_ssrg_list_iterable))
const anyRange = (unit: undefined) => yesNo(anyPositive(_ssrg_range_inclusive(0, 2))(_ssrg_range_iterable))
const anyEmpty = (unit: undefined) => yesNo(anyPositive(emptyValues(undefined))(_ssrg_array_iterable))
const allArray = (unit: undefined) => yesNo(allPositive([1, 2, 3])(_ssrg_array_iterable))
const allList = (unit: undefined) => yesNo(allPositive(_ssrg_list_from_array([1, 2, 3]))(_ssrg_list_iterable))
const allRange = (unit: undefined) => yesNo(allPositive(_ssrg_range_inclusive(1, 3))(_ssrg_range_iterable))

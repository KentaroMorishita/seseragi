...
export const __ssrg$instance$Show$0: _ssrg_show_Show<UserId> = { show: (value: UserId): string => { switch (value.tag) { case "UserId": return "UserId" + " " + _ssrg_show_intShow.show(value.value); } } };
export const __ssrg$instance$Debug$1: _ssrg_debug_Debug<UserId> = { debug: (value: UserId): string => { switch (value.tag) { case "UserId": return "UserId" + " " + _ssrg_debug_intDebug.debug(value.value); } } };
export const __ssrg$instance$Show$2 = <A,>(__ssrg$evidence$0: Readonly<Record<string, (...args: any[]) => any>>): _ssrg_show_Show<Packet<A>> => ({ show: (value: Packet<A>): string => { switch (value.tag) { case "Empty": return "Empty"; case "Packet": return "Packet" + " " + (_ssrg_show_arrayShow<A>(__ssrg$evidence$0)).show(value.value); } } });
export const __ssrg$instance$Debug$3 = <A,>(__ssrg$evidence$0: Readonly<Record<string, (...args: any[]) => any>>): _ssrg_debug_Debug<Packet<A>> => ({ debug: (value: Packet<A>): string => { switch (value.tag) { case "Empty": return "Empty"; case "Packet": return "Packet" + " " + (_ssrg_debug_arrayDebug<A>(__ssrg$evidence$0)).debug(value.value); } } });
export const __ssrg$instance$Show$4 = <A,>(__ssrg$evidence$0: Readonly<Record<string, (...args: any[]) => any>>): _ssrg_show_Show<Envelope<A>> => ({ show: (value: Envelope<A>): string => "Envelope { " + "label: " + _ssrg_show_stringShow.show(value["label"]) + ", " + "value: " + (__ssrg$evidence$0).show(value["value"]) + ", " + "range: " + (_ssrg_show_rangeShow<bigint>(_ssrg_show_intShow)).show(value["range"]) + ", " + "summary: " + (_ssrg_show_tupleShow<readonly [bigint, string]>(_ssrg_show_intShow, _ssrg_show_stringShow)).show(value["summary"]) + ", " + "metadata: " + (_ssrg_show_recordShow<{ readonly "active": boolean }>(["active"] as const, [false] as const, _ssrg_show_boolShow)).show(value["metadata"]) + " }" });
export const __ssrg$instance$Debug$5 = <A,>(__ssrg$evidence$0: Readonly<Record<string, (...args: any[]) => any>>): _ssrg_debug_Debug<Envelope<A>> => ({ debug: (value: Envelope<A>): string => "Envelope { " + "label: " + _ssrg_debug_stringDebug.debug(value["label"]) + ", " + "value: " + (__ssrg$evidence$0).debug(value["value"]) + ", " + "range: " + (_ssrg_debug_rangeDebug<bigint>(_ssrg_debug_intDebug)).debug(value["range"]) + ", " + "summary: " + (_ssrg_debug_tupleDebug<readonly [bigint, string]>(_ssrg_debug_intDebug, _ssrg_debug_stringDebug)).debug(value["summary"]) + ", " + "metadata: " + (_ssrg_debug_recordDebug<{ readonly "active": boolean }>(["active"] as const, [false] as const, _ssrg_debug_boolDebug)).debug(value["metadata"]) + " }" });
export const __ssrg$instance$Debug$6: _ssrg_debug_Debug<Stats> = { debug: (value: Stats): string => "Stats { " + "total: " + _ssrg_debug_intDebug.debug(value["total"]) + ", " + "ratio: " + _ssrg_debug_floatDebug.debug(value["ratio"]) + " }" };

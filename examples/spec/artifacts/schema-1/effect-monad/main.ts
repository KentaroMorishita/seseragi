...
const source: Effect<{  }, never, number> = ((_ssrg_effect_applicative["pure"](41)) as Effect<{  }, never, number>);
const liftedIncrement: Effect<{  }, never, (argument: number) => number> = ((_ssrg_effect_applicative["pure"](increment)) as Effect<{  }, never, (argument: number) => number>);
const plusTen: (argument: number) => Effect<{  }, never, number> = (value: number) => ((_ssrg_effect_applicative["pure"](_ssrg_int_add(value, 10))) as Effect<{  }, never, number>);
const mapped: Effect<{  }, never, number> = ((_ssrg_effect_functor["map"](increment)(source)) as Effect<{  }, never, number>);
const applied: Effect<{  }, never, number> = ((_ssrg_effect_applicative["apply"](liftedIncrement)(source)) as Effect<{  }, never, number>);
const chained: Effect<{  }, never, number> = ((_ssrg_effect_monad["flatMap"](plusTen)(source)) as Effect<{  }, never, number>);

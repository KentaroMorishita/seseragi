...
export const main = (_unit: undefined) => _ssrg_console_println(render(((transformWith(increment)(_ssrg_maybe_Just(41))(__ssrg$instance$Functor$0)) as { readonly tag: "Nothing" } | { readonly tag: "Just"; readonly value: number })))

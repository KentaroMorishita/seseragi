...
const transformWith = <F, A, B,>(f: (argument: A) => B) => (value: unknown) => (__ssrg$evidence$0: Readonly<Record<string, (...args: any[]) => any>>) => applyMapper((__ssrg$partial$0: unknown) => transform(f)(__ssrg$partial$0)(__ssrg$evidence$0))(value)
...
export const main = (_unit: undefined) => _ssrg_console_println(render(transformWith(increment)(_ssrg_maybe_Just(41n))(__ssrg$instance$Functor$0)))

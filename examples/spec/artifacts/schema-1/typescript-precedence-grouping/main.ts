...
export const main = (_unit: undefined) => _ssrg_effect_flatMap(_ssrg_console_println(((_ssrg_debug_arrayDebug<number>(_ssrg_debug_floatDebug)["debug"]([ratio(3.0), ratio(7.0), ratio(1.0)])) as string)), () => _ssrg_effect_flatMap(_ssrg_console_println(((_ssrg_debug_arrayDebug<number>(_ssrg_debug_floatDebug)["debug"]([averageDifference(9.0)(1.0), averageDifference(2.0)(6.0)])) as string)), () => _ssrg_console_println(((_ssrg_debug_floatDebug["debug"](groupedThroughPipeline)) as string))))

...
const total = (values: ReadonlyArray<number>) => addBonus(0)(_ssrg_array_reduce(Score(0), (_argument0) => (_argument1) => __ssrg$instance$Add$0["add"](_argument0)(_argument1), values))

...
const label = <T,>(value: T) => (__ssrg$evidence$0: Readonly<Record<string, (...args: any[]) => any>>) => applyLabel((__ssrg$partial$0: string) => describe(value)(__ssrg$partial$0)(__ssrg$evidence$0))
export const main = (_unit: undefined) => _ssrg_console_println(label(Active)(__ssrg$instance$Ready$0))

...
const subtractFromTen = (right: number) => applyOne((__ssrg$partial$0: number) => __ssrg$operator$3c5e3e(10)(__ssrg$partial$0)(__ssrg$instance$Difference$0))(right)
export const main = (_unit: undefined) => _ssrg_console_println("Custom operator section: higher-order=" + _ssrg_show_intShow["show"](applyPair((__ssrg$partial$0: number) => (__ssrg$partial$1: number) => __ssrg$operator$3c5e3e(__ssrg$partial$0)(__ssrg$partial$1)(__ssrg$instance$Difference$0))(10)(3)) + ", partial=" + _ssrg_show_intShow["show"](subtractFromTen(3)))

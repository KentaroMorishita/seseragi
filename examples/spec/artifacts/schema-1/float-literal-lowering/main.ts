...
export const main = (_unit: undefined) => _ssrg_effect_flatMap(_ssrg_console_println(((_ssrg_debug_arrayDebug<number>(_ssrg_debug_floatDebug)["debug"](values)) as string)), () => _ssrg_effect_flatMap(_ssrg_console_println(((_ssrg_debug_tupleDebug<readonly [number, number]>(_ssrg_debug_floatDebug, _ssrg_debug_floatDebug)["debug"](pair)) as string)), () => _ssrg_effect_flatMap(_ssrg_console_println(((_ssrg_debug_recordDebug<{ readonly "value": number }>(["value"] as const, [false] as const, _ssrg_debug_floatDebug)["debug"](sample)) as string)), () => _ssrg_effect_flatMap(_ssrg_console_println(((_ssrg_show_floatShow["show"](1.0)) as string)), () => _ssrg_console_println(((_ssrg_debug_floatDebug["debug"]((measurement)["reading"])) as string))))))

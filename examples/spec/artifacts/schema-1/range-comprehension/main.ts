...
const evenSquares = (limit: number) => _ssrg_range_comprehend(_ssrg_range_inclusive(1, limit), (value) => _ssrg_int_eq_dictionary["eq"](_ssrg_int_remainder(value, 2))(0), (value) => _ssrg_int_multiply(value, value))
const total = (unit: undefined) => _ssrg_array_reduce(0, (((_argument0) => (_argument1) => _ssrg_int_add(_argument0, _argument1)) as (argument: number) => (argument: number) => number), evenSquares(10))

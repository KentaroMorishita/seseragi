...
const applyMapper = (mapper: (argument: { readonly tag: "Nothing" } | { readonly tag: "Just"; readonly value: bigint }) => { readonly tag: "Nothing" } | { readonly tag: "Just"; readonly value: bigint }) => (value: { readonly tag: "Nothing" } | { readonly tag: "Just"; readonly value: bigint }) => mapper(value)
...
export const main = (_unit: undefined) => _ssrg_console_println(render(applyMapper(__ssrg$instance$Functor$0["map"](increment))(_ssrg_maybe_Just(41n))))

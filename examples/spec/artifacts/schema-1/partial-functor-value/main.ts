...
export const main = (_unit: undefined) => _ssrg_console_println(render(applyMapper(((__ssrg$instance$Functor$0["map"](increment)) as (argument: { readonly tag: "Nothing" } | { readonly tag: "Just"; readonly value: number }) => { readonly tag: "Nothing" } | { readonly tag: "Just"; readonly value: number }))(_ssrg_maybe_Just(41))))

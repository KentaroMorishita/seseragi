...
const update = (count: MutableSignal<bigint>) => (message: Msg) => (($ssrg_match: Msg): Effect<{  }, never, undefined> => _ssrg_signal_update((value: bigint) => _ssrg_int64_add(value, 1n), count))(message)

...
const page = (docsUrl: WebUrl) => (markUrl: WebUrl) => _ssrg_html_div(({ "id": "app", "class": "container", "children": [_ssrg_html_p(({ "children": "Hello <Seseragi>" } as const)), _ssrg_html_button(({ "onClick": Confirm, "children": "OK" } as const)), _ssrg_html_a(({ "href": docsUrl, "children": _ssrg_html_img(({ "src": markUrl, "alt": "Seseragi documentation" } as const)) } as const))] } as const))

...
export const selectedPairs = (unit: undefined) => _ssrg_array_comprehend_flat([1, 2], (left) => true, (left) => _ssrg_array_comprehend([10, 20], (right) => right === 20, (right) => _ssrg_int_add(left, right)))

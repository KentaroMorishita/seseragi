...
export const main = (_unit: undefined) => _ssrg_effect_flatMap(_ssrg_console_println(render("List map")(total(((_ssrg_list_functor["map"](increment)(_ssrg_list_from_array([1, 2, 3]))) as List<number>)))), () => _ssrg_effect_flatMap(_ssrg_console_println(render("List apply")(total(((_ssrg_list_applicative["apply"](((_ssrg_list_applicative["pure"](increment)) as List<(argument: number) => number>))(_ssrg_list_from_array([40, 41]))) as List<number>)))), () => _ssrg_console_println(render("List flatMap")(total(((_ssrg_list_monad["flatMap"](expand)(_ssrg_list_from_array([1, 2]))) as List<number>))))))

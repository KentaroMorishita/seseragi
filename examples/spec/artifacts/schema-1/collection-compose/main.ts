...
const nestedLists = (unit: undefined) => _ssrg_list_from_array([_ssrg_list_from_array([1, 2]), _ssrg_list_from_array([] as ReadonlyArray<number>), _ssrg_list_from_array([3, 4])])
export const collectionComposeResults = (unit: undefined) => [showArray(_ssrg_array_append([3, 4], [1, 2])), showList(_ssrg_list_append(_ssrg_list_from_array([3, 4]), _ssrg_list_from_array([1, 2]))), showArray(_ssrg_array_concat([[1, 2], [] as ReadonlyArray<number>, [3, 4]])), showList(_ssrg_list_concat(nestedLists(undefined))), showArray(_ssrg_array_reverse([1, 2, 3])), showList(_ssrg_list_reverse(_ssrg_list_from_array([1, 2, 3]))), showArray(_ssrg_array_concat([] as ReadonlyArray<ReadonlyArray<number>>)), showList(_ssrg_list_concat(_ssrg_list_from_array([] as ReadonlyArray<List<number>>)))]

...
export const badgeLabel = (value: Badge) => ((__ssrg$instance$Render$0["present"](value)) as string)
export const modeLabel = (value: Mode) => ((__ssrg$instance$Describe$1["present"](value)) as string)

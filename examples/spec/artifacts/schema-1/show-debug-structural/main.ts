...
export const showTuple = (value: readonly [bigint, string]) => _ssrg_show_tupleShow<readonly [bigint, string]>(_ssrg_show_intShow, _ssrg_show_stringShow)["show"](value)
export const debugRecord = (value: { readonly "zeta"?: string; readonly "alpha": bigint }) => _ssrg_debug_recordDebug<{ readonly "zeta"?: string; readonly "alpha": bigint }>(["alpha", "zeta"] as const, [false, true] as const, _ssrg_debug_intDebug, _ssrg_debug_stringDebug)["debug"](value)
export const debugNested = (value: { readonly "ranges": ReadonlyArray<readonly [Readonly<{ start: bigint; end: bigint; inclusive: boolean }>, boolean]>; readonly "label"?: string }) => _ssrg_debug_recordDebug<{ readonly "ranges": ReadonlyArray<readonly [Readonly<{ start: bigint; end: bigint; inclusive: boolean }>, boolean]>; readonly "label"?: string }>(["label", "ranges"] as const, [true, false] as const, _ssrg_debug_stringDebug, _ssrg_debug_arrayDebug<readonly [Readonly<{ start: bigint; end: bigint; inclusive: boolean }>, boolean]>(_ssrg_debug_tupleDebug<readonly [Readonly<{ start: bigint; end: bigint; inclusive: boolean }>, boolean]>(_ssrg_debug_rangeDebug<bigint>(_ssrg_debug_intDebug), _ssrg_debug_boolDebug)))["debug"](value)
...
export const main = (_unit: undefined) => _ssrg_effect_flatMap(_ssrg_console_println(showTuple([42n, "ready"] as const)), () => _ssrg_effect_flatMap(_ssrg_console_println(debugRecord(({ "alpha": 1n } as const))), () => _ssrg_effect_flatMap(_ssrg_console_println(debugRecord(({ "zeta": "last", "alpha": 1n } as const))), () => _ssrg_effect_flatMap(_ssrg_console_println(debugNested(({ "ranges": [[_ssrg_range_exclusive(1n, 3n), true] as const, [_ssrg_range_inclusive(3n, 3n), false] as const] } as const))), () => _ssrg_console_println(debugBadgeRecord(({ "badge": Active } as const)))))))

import { section as _ssrg_html_section, style as _ssrg_html_style, h2 as _ssrg_html_h2, p as _ssrg_html_p, main as _ssrg_html_main, h1 as _ssrg_html_h1, renderToString as _ssrg_html_renderToString, type Html as Html, type Style as Style } from "@seseragi/runtime/html"
import { println as _ssrg_console_println } from "@seseragi/runtime/console"

type Msg =
  | { readonly tag: "Confirm" };
const Confirm: Msg = { tag: "Confirm" } as const;
const card = (title: string) => (detail: string) => _ssrg_html_section(({ "className": "card", "style": _ssrg_html_style(({ "variables": ({ "cardShadow": "0 4px 16px #0002" } as const), "backgroundColor": "#fff", "boxShadow": "var(--card-shadow)", "borderRadius": "16px", "padding": "24px" } as const)), "children": [_ssrg_html_h2(({ "style": _ssrg_html_style(({ "color": "#185f50", "marginTop": "0" } as const)), "children": title } as const)), _ssrg_html_p(({ "style": _ssrg_html_style(({ "color": "#315c53", "marginBottom": "0" } as const)), "children": detail } as const))] } as const))

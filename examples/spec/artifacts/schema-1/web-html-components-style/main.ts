...
const card = (title: string) => (detail: string) => _ssrg_html_section(({ "class": "mx-auto max-w-xl", "style": cardStyle, "children": [_ssrg_html_h2(({ "style": _ssrg_html_style(({ "color": "#185f50", "marginTop": "0" } as const)), "children": title } as const)), _ssrg_html_p(({ "style": _ssrg_html_style(({ "color": "#315c53", "marginBottom": "0" } as const)), "children": detail } as const))] } as const))
const page = (_unit: undefined) => _ssrg_html_main(({ "id": "app", "class": "min-h-screen bg-emerald-50 p-8 sm:p-12", "children": [_ssrg_html_h1(({ "onClick": Confirm, "class": "mx-auto mb-6 max-w-xl text-3xl font-bold text-emerald-950", "children": "Seseragi components" } as const)), card("Reusable card")("Function component from children")] } as const))

...
provider methodの実結果を観測するため、interface transportだけでgreenにはなりません。generic / constraint付きimported
factoryとfacade越しのtransitive instance closureはこのcaseの完了条件に含みません。

...
| `log-correlation` | `run` | `cli-run` | `crates/seseragi-cli/tests/run.rs` |
...
| `web-scene-interaction` | `compile` | `cli-build` | `apps/playground/tests/web-scene-interaction-browser.test.ts` |

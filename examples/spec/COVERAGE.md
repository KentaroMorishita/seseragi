...
| custom trait / instance / custom operator     | Lesson 13         | `interface-schema-1/{basic-trait,rich}` method contract / implementation preservation + orphan / fixity / `project-schema-1/imported-effect-failure` | partial |

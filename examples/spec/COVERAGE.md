...
| Monad、`>>=`、do desugar                      | Lesson 10         | `schema-1/monad-maybe` + `execution-schema-1/monad-maybe`; transitive supertrait、generic `pure` / `flatMap`、`>>=`、Maybe short-circuit。do / lawは未接続 | partial |

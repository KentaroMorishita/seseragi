...
| structural record value / optional field / presence | Lesson 27  | `schema-1/record-profile` + `execution-schema-1/record-profile` + `semantic-diagnostics-schema-1/record-field-errors` + `compile/optional-record-field.ssrg`; explicit / shorthand literal、required access、optional accessのMaybe presence、width subtyping、readonly TS object、duplicate / missing field diagnosticを接続。spread、record patternは未接続 | partial |

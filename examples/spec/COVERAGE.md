...
| structural record value / optional field / presence | Lesson 27  | `schema-1/record-profile` + `execution-schema-1/record-profile` + `semantic-diagnostics-schema-1/record-field-errors` + `compile/optional-record-field.ssrg`; explicit / shorthand literal、required access、width subtyping、readonly TS object、duplicate / missing field diagnosticを接続。optional accessのMaybe、spread、record patternは未接続 | partial |

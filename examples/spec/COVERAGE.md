...
| custom trait / instance / custom operator     | Lesson 13         | `interface-schema-1/rich` method-preserving Surface / Resolved AST + orphan / fixity / `project-schema-1/imported-effect-failure` | partial |

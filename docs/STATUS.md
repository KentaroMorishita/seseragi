...
| module、package、project                   | 初稿あり      | module graph・lock・manifest fixtureあり   | linked rank-1 / namespace value・type + backend project executionまで部分実装 |
...
3. namespace-qualified constructor expression / patternとexhaustivenessを小さいfixtureで閉じ、trait / nested namespace、higher-order callable、

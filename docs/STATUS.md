...
- 規範仕様: `docs/spec/00-language.md` から `13-web-ui.md` とAppendix grammar
...
3. 失敗条件を持つ機能へdiagnosticまたはruntime fixtureを追加する。
4. module、interop、package、DOMをmulti-file project fixtureで固定する。

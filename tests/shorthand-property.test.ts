...
describe("Shorthand Property Notation Tests", () => {
  ...
  test("should detect undefined variable in shorthand property", () => {
    ...
    expect(inferenceResult.errors.some(e => e.message.includes("Undefined variable 'x'"))).toBe(true)
    expect(inferenceResult.errors.some(e => e.message.includes("Undefined variable 'y'"))).toBe(true)
  })
})
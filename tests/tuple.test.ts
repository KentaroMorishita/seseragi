...
describe("Tuple Feature Tests", () => {
  ...
  describe("Code Generation - Tuple to TypeScript", () => {
    ...
    test("should generate tuple destructuring", () => {
      ...
      expect(code).toBe("const [x, y] = { tag: 'Tuple', elements: [1, 2] }.tag === 'Tuple' ? { tag: 'Tuple', elements: [1, 2] }.elements : { tag: 'Tuple', elements: [1, 2] };")
    })
    ...
    test("should generate destructuring with wildcard", () => {
      ...
      expect(code).toBe("const [x, _1] = { tag: 'Tuple', elements: [1, 2] }.tag === 'Tuple' ? { tag: 'Tuple', elements: [1, 2] }.elements : { tag: 'Tuple', elements: [1, 2] };")
    })
    ...
    test("should generate unique names for multiple wildcards", () => {
      ...
      expect(code).toBe("const [_1, x, _2, y, _3] = { tag: 'Tuple', elements: [1, 2, 3, 4, 5] }.tag === 'Tuple' ? { tag: 'Tuple', elements: [1, 2, 3, 4, 5] }.elements : { tag: 'Tuple', elements: [1, 2, 3, 4, 5] };")
    })
    ...
    test("should generate globally unique wildcard names across statements", () => {
      ...
      expect(code1).toBe("const [_1, x, _2] = { tag: 'Tuple', elements: [1, 2, 3] }.tag === 'Tuple' ? { tag: 'Tuple', elements: [1, 2, 3] }.elements : { tag: 'Tuple', elements: [1, 2, 3] };")
      expect(code2).toBe("const [_3, y, _4] = { tag: 'Tuple', elements: [4, 5, 6] }.tag === 'Tuple' ? { tag: 'Tuple', elements: [4, 5, 6] }.elements : { tag: 'Tuple', elements: [4, 5, 6] };")
    })
  })

...
Regenerate with the pinned versions above. A renderer upgrade must intentionally refresh both derived files and their contract hashes in the same change.

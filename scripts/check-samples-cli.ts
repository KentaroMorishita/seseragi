...
console.log(
  `Validated ${checked} executable samples, ${checkedTourLessons} Tour lessons, ${checkedTourExercises} exercises and ${checkedTourDiagnostics} diagnostic examples with the native Seseragi CLI (${samples.length - checked + tourLessons.length - checkedTourLessons} browser-interactive skipped).`
)

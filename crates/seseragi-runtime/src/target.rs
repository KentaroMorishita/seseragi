...
fn service_identity(service: HostService) -> &'static str {
    match service {
        ...
        HostService::ChildProcesses => "std/child-process::ChildProcesses",
        HostService::Dom => "std/web/dom::Dom",
        HostService::Clock => "std/clock::Clock",
        HostService::TimeZones => "std/time::TimeZones",
        HostService::Random => "std/random::Random",
        HostService::Entropy => "std/entropy::Entropy",
...
fn host_service(identity: &str) -> Option<HostService> {
    match identity {
        ...
        "std/child-process::ChildProcesses" => Some(HostService::ChildProcesses),
        "std/web/dom::Dom" => Some(HostService::Dom),
        "std/clock::Clock" => Some(HostService::Clock),
        "std/time::TimeZones" => Some(HostService::TimeZones),
        "std/random::Random" => Some(HostService::Random),
        "std/entropy::Entropy" => Some(HostService::Entropy),

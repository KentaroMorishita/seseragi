...
const RUNTIME_EFFECT_OPERATIONS: &[RuntimeEffectOperation] = &[
    surface_operation!(
        ...
        "@seseragi/runtime/test",
        "AssertionFailed"
    ),
    surface_operation!(
        "std/test::ExpectedTypedFailure",
        "test.failure.expected-typed",
        "_ssrg_test_ExpectedTypedFailure",
        "@seseragi/runtime/test",
        "ExpectedTypedFailure"
    ),
    surface_operation!(
        "std/test::TypedFailureDidNotMatch",
        "test.failure.typed-mismatch",
        "_ssrg_test_TypedFailureDidNotMatch",
        "@seseragi/runtime/test",
        "TypedFailureDidNotMatch"
    ),
    surface_operation!(
        "std/test::ExplicitTestFailure",
        "test.failure.explicit",
        "_ssrg_test_ExplicitTestFailure",
        "@seseragi/runtime/test",
        "ExplicitTestFailure"
    ),
    surface_operation!(
    ...
    surface_operation!(
        "std/test::expectFailure",
        "test.assert.expect-failure",
        "_ssrg_test_expectFailure",
        "@seseragi/runtime/test",
        "expectFailure"
    ),
    RuntimeEffectOperation {
    ...
    surface_operation!(
        "std/time::InvalidDate",
        "time.invalid-date",
        "_ssrg_time_InvalidDate",
        "@seseragi/runtime/time",
        "InvalidDate"
    ),
    surface_operation!(
        "std/time::InvalidTime",
        "time.invalid-time",
        "_ssrg_time_InvalidTime",
        "@seseragi/runtime/time",
        "InvalidTime"
    ),
    surface_operation!(
        "std/time::InvalidUtcOffsetSeconds",
        "time.invalid-offset",
        "_ssrg_time_InvalidUtcOffsetSeconds",
        "@seseragi/runtime/time",
        "InvalidUtcOffsetSeconds"
    ),
    surface_operation!(
        "std/time::InvalidDateTimeText",
        "time.invalid-text",
        "_ssrg_time_InvalidDateTimeText",
        "@seseragi/runtime/time",
        "InvalidDateTimeText"
    ),
    surface_operation!(
        "std/time::UnknownTimeZone",
        "time.unknown-zone",
        "_ssrg_time_UnknownTimeZone",
        "@seseragi/runtime/time",
        "UnknownTimeZone"
    ),
    surface_operation!(
        "std/time::TimeZoneDatabaseUnavailable",
        "time.database-unavailable",
        "_ssrg_time_TimeZoneDatabaseUnavailable",
        "@seseragi/runtime/time",
        "TimeZoneDatabaseUnavailable"
    ),
    surface_operation!(
        "std/time::TimeZoneDatabaseVersionMismatch",
        "time.database-version-mismatch",
        "_ssrg_time_TimeZoneDatabaseVersionMismatch",
        "@seseragi/runtime/time",
        "TimeZoneDatabaseVersionMismatch"
    ),
    surface_operation!(
        "std/time::Unique",
        "time.resolution.unique",
        "_ssrg_time_Unique",
        "@seseragi/runtime/time",
        "Unique"
    ),
    surface_operation!(
        "std/time::Ambiguous",
        "time.resolution.ambiguous",
        "_ssrg_time_Ambiguous",
        "@seseragi/runtime/time",
        "Ambiguous"
    ),
    surface_operation!(
    ...
    surface_operation!(
        "std/time::utcOffset",
        "time.utc-offset",
        "_ssrg_time_utcOffset",
        "@seseragi/runtime/time",
        "utcOffset"
    ),
    surface_operation!(
        "std/time::parseLocalDate",
        "time.parse-local-date",
        "_ssrg_time_parseLocalDate",
        "@seseragi/runtime/time",
        "parseLocalDate"
    ),
    surface_operation!(
        "std/time::parseLocalTime",
        "time.parse-local-time",
        "_ssrg_time_parseLocalTime",
        "@seseragi/runtime/time",
        "parseLocalTime"
    ),
    surface_operation!(
        "std/time::parseLocalDateTime",
        "time.parse-local-date-time",
        "_ssrg_time_parseLocalDateTime",
        "@seseragi/runtime/time",
        "parseLocalDateTime"
    ),
    surface_operation!(
        "std/time::parseOffsetDateTime",
        "time.parse-offset-date-time",
        "_ssrg_time_parseOffsetDateTime",
        "@seseragi/runtime/time",
        "parseOffsetDateTime"
    ),
    surface_operation!(
        "std/time::formatLocalDate",
        "time.format-local-date",
        "_ssrg_time_formatLocalDate",
        "@seseragi/runtime/time",
        "formatLocalDate"
    ),
    surface_operation!(
        "std/time::formatLocalTime",
        "time.format-local-time",
        "_ssrg_time_formatLocalTime",
        "@seseragi/runtime/time",
        "formatLocalTime"
    ),
    surface_operation!(
        "std/time::formatLocalDateTime",
        "time.format-local-date-time",
        "_ssrg_time_formatLocalDateTime",
        "@seseragi/runtime/time",
        "formatLocalDateTime"
    ),
    surface_operation!(
        "std/time::formatOffsetDateTime",
        "time.format-offset-date-time",
        "_ssrg_time_formatOffsetDateTime",
        "@seseragi/runtime/time",
    ...
    surface_operation!(
        "std/time::offsetInstant",
        "time.offset-instant",
        "_ssrg_time_offsetInstant",
        "@seseragi/runtime/time",
        "offsetInstant"
    ),
    surface_operation!(
        "std/time::offsetLocalDateTime",
        "time.offset-local-date-time",
        "_ssrg_time_offsetLocalDateTime",
        "@seseragi/runtime/time",
        "offsetLocalDateTime"
    ),
    surface_operation!(
        "std/time::timeZoneId",
        "time.zone-id",
        "_ssrg_time_timeZoneId",
        "@seseragi/runtime/time",
        "timeZoneId"
    ),
    surface_operation!(
        "std/time::timeZoneVersion",
        "time.zone-version",
        "_ssrg_time_timeZoneVersion",
        "@seseragi/runtime/time",
        "timeZoneVersion"
    ),
    surface_operation!(
        "std/time::atTimeZone",
        "time.at-zone",
        "_ssrg_time_atTimeZone",
        "@seseragi/runtime/time",
        "atTimeZone"
    ),
    surface_operation!(
        "std/time::resolveLocal",
        "time.resolve-local",
    ...
    surface_operation!(
        "std/time::zonedInstant",
        "time.zoned-instant",
        "_ssrg_time_zonedInstant",
        "@seseragi/runtime/time",
        "zonedInstant"
    ),
    surface_operation!(
        "std/time::zonedLocalDateTime",
        "time.zoned-local-date-time",
        "_ssrg_time_zonedLocalDateTime",
        "@seseragi/runtime/time",
        "zonedLocalDateTime"
    ),
    surface_operation!(
        "std/time::zonedOffset",
        "time.zoned-offset",
        "_ssrg_time_zonedOffset",
        "@seseragi/runtime/time",
        "zonedOffset"
    ),
    surface_operation!(
        "std/time::zonedTimeZone",
        "time.zoned-zone",
        "_ssrg_time_zonedTimeZone",
        "@seseragi/runtime/time",
        "zonedTimeZone"
    ),
];

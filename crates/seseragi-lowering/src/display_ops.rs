...
const RUNTIME_DISPLAY_DICTIONARIES: &[RuntimeDisplayDictionary] = &[
    ...
    display_dictionary!(
        "Debug<std/text::TextSliceError>",
        "core.text.slice-error.debug",
        "_ssrg_textSliceErrorDebug",
        "textSliceErrorDebug"
    ),
    display_dictionary!(
        "Show<std/text/grapheme::GraphemeSliceError>",
        "core.text.grapheme.slice-error.show",
        "_ssrg_graphemeSliceErrorShow",
        "graphemeSliceErrorShow"
    ),
    display_dictionary!(
        "Debug<std/text/grapheme::GraphemeSliceError>",
        "core.text.grapheme.slice-error.debug",
        "_ssrg_graphemeSliceErrorDebug",
        "graphemeSliceErrorDebug"
    ),
    display_dictionary!(
        "Show<std/text/unicode::NormalizationForm>",
        "core.text.unicode.normalization-form.show",
        "_ssrg_normalizationFormShow",
        "normalizationFormShow"
    ),
    display_dictionary!(
        "Debug<std/text/unicode::NormalizationForm>",
        "core.text.unicode.normalization-form.debug",
        "_ssrg_normalizationFormDebug",
        "normalizationFormDebug"
    ),
    display_dictionary!(
        "Show<std/text/unicode::UnicodeGeneralCategory>",
        "core.text.unicode.category.show",
        "_ssrg_unicodeGeneralCategoryShow",
        "unicodeGeneralCategoryShow"
    ),
    display_dictionary!(
        "Debug<std/text/unicode::UnicodeGeneralCategory>",
        "core.text.unicode.category.debug",
        "_ssrg_unicodeGeneralCategoryDebug",
        "unicodeGeneralCategoryDebug"
    ),
    display_dictionary!(
        "Show<std/regex::RegexCompileErrorKind>",
        "core.regex.compile-error-kind.show",
        "_ssrg_regexCompileErrorKindShow",
        "regexCompileErrorKindShow"
    ),
    display_dictionary!(
        "Debug<std/regex::RegexCompileErrorKind>",
        "core.regex.compile-error-kind.debug",
        "_ssrg_regexCompileErrorKindDebug",
        "regexCompileErrorKindDebug"
    ),
    display_dictionary!(
        "Show<std/regex::RegexCompileError>",
        "core.regex.compile-error.show",
        "_ssrg_regexCompileErrorShow",
        "regexCompileErrorShow"
    ),
    display_dictionary!(
        "Debug<std/regex::RegexCompileError>",
        "core.regex.compile-error.debug",
        "_ssrg_regexCompileErrorDebug",
        "regexCompileErrorDebug"
    ),
    display_dictionary!(
        "Show<std/regex::RegexOptions>",
        "core.regex.options.show",
        "_ssrg_regexOptionsShow",
        "regexOptionsShow"
    ),
    display_dictionary!(
        "Debug<std/regex::RegexOptions>",
        "core.regex.options.debug",
        "_ssrg_regexOptionsDebug",
        "regexOptionsDebug"
    ),
    display_dictionary!(
        "Show<std/regex::RegexSpan>",
        "core.regex.span.show",
        "_ssrg_regexSpanShow",
        "regexSpanShow"
    ),
    display_dictionary!(
        "Debug<std/regex::RegexSpan>",
        "core.regex.span.debug",
        "_ssrg_regexSpanDebug",
        "regexSpanDebug"
    ),
    display_dictionary!(
        "Show<std/regex::RegexCapture>",
        "core.regex.capture.show",
        "_ssrg_regexCaptureShow",
        "regexCaptureShow"
    ),
    display_dictionary!(
        "Debug<std/regex::RegexCapture>",
        "core.regex.capture.debug",
        "_ssrg_regexCaptureDebug",
        "regexCaptureDebug"
    ),
    display_dictionary!(
        "Show<std/regex::RegexMatch>",
        "core.regex.match.show",
        "_ssrg_regexMatchShow",
        "regexMatchShow"
    ),
    display_dictionary!(
        "Debug<std/regex::RegexMatch>",
        "core.regex.match.debug",
        "_ssrg_regexMatchDebug",
        "regexMatchDebug"
    ),
    RuntimeDisplayDictionary {
    ...
    display_dictionary!(
        ...
        "random.range-error.show",
        "_ssrg_show_randomRangeErrorShow",
        "randomRangeErrorShow"
    ),
    display_dictionary!(
        "Debug<std/random::RandomRangeError>",
        "random.range-error.debug",
        "_ssrg_debug_randomRangeErrorDebug",
        "randomRangeErrorDebug"
    ),
    display_dictionary!(
        "Show<std/random::RandomConfigError>",
        "random.config-error.show",
        "_ssrg_show_randomConfigErrorShow",
        "randomConfigErrorShow"
    ),
    display_dictionary!(
        "Debug<std/random::RandomConfigError>",
        "random.config-error.debug",
        "_ssrg_debug_randomConfigErrorDebug",
        "randomConfigErrorDebug"
    ),
    display_dictionary!(
        "Show<std/entropy::EntropyConfigError>",
        "entropy.config-error.show",
        "_ssrg_show_entropyConfigErrorShow",
        "entropyConfigErrorShow"
    ),
    display_dictionary!(
        "Debug<std/entropy::EntropyConfigError>",
        "entropy.config-error.debug",
        "_ssrg_debug_entropyConfigErrorDebug",
        "entropyConfigErrorDebug"
    ),
    display_dictionary!(
        "Show<std/entropy::EntropyError>",
        "entropy.error.show",
        "_ssrg_show_entropyErrorShow",
        "entropyErrorShow"
    ),
    display_dictionary!(
        "Debug<std/entropy::EntropyError>",
        "entropy.error.debug",
        "_ssrg_debug_entropyErrorDebug",
        "entropyErrorDebug"
    ),
    RuntimeDisplayDictionary {
    ...
    RuntimeDisplayDictionary {
        semantic_identity: "Show<std/time::DateTimeError>",
        runtime_feature: "time.date-time-error.show",
        local_name: "_ssrg_show_dateTimeErrorShow",
        module: "@seseragi/runtime/show",
        export_name: "dateTimeErrorShow",
        source_map_name: "dateTimeErrorShow",
    },
    RuntimeDisplayDictionary {
        semantic_identity: "Debug<std/time::DateTimeError>",
        runtime_feature: "time.date-time-error.debug",
        local_name: "_ssrg_debug_dateTimeErrorDebug",
        module: "@seseragi/runtime/show",
        export_name: "dateTimeErrorDebug",
        source_map_name: "dateTimeErrorDebug",
    },
    RuntimeDisplayDictionary {
        semantic_identity: "Show<std/time::TimeZoneError>",
        runtime_feature: "time.zone-error.show",
        local_name: "_ssrg_show_timeZoneErrorShow",
        module: "@seseragi/runtime/show",
        export_name: "timeZoneErrorShow",
        source_map_name: "timeZoneErrorShow",
    },
    RuntimeDisplayDictionary {
        semantic_identity: "Debug<std/time::TimeZoneError>",
        runtime_feature: "time.zone-error.debug",
        local_name: "_ssrg_debug_timeZoneErrorDebug",
        module: "@seseragi/runtime/show",
        export_name: "timeZoneErrorDebug",
        source_map_name: "timeZoneErrorDebug",
    },
    display_dictionary!(

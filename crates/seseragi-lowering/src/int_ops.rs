...
const RUNTIME_INT_OPERATIONS: &[RuntimeIntOperation] = &[
    ...
    RuntimeIntOperation {
        ...
        runtime_feature: "core.int.subtract",
        local_name: "_ssrg_int_subtract",
        module: "@seseragi/runtime/int",
    ...
    RuntimeIntOperation {
        ...
        runtime_feature: "core.int.multiply",
        local_name: "_ssrg_int_multiply",
        module: "@seseragi/runtime/int",
    ...
    RuntimeIntOperation {
        ...
        runtime_feature: "core.int.divide",
        local_name: "_ssrg_int_divide",
        module: "@seseragi/runtime/int",
        export_name: "divide",
    ...
    RuntimeIntOperation {
        ...
        runtime_feature: "core.int.remainder",
        local_name: "_ssrg_int_remainder",
        module: "@seseragi/runtime/int",
    ...
    RuntimeIntOperation {
        ...
        runtime_feature: "core.int.power",
        local_name: "_ssrg_int_power",
        module: "@seseragi/runtime/int",
        export_name: "power",

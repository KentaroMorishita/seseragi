...
fn categories(suite: &Suite) -> Vec<Category<'_>> {
    vec![
        ...
        Category {
            json_key: "providerDesignValidation",
            text_label: "Provider Design Validation",
            cases: &suite.provider_design_validation_cases,
        },
        Category {
            json_key: "providerLifecycle",
            text_label: "Provider Lifecycle",
            cases: &suite.provider_lifecycle_cases,
        },
        Category {
            json_key: "providerManifest",
            text_label: "Provider Manifest",
            cases: &suite.provider_manifest_cases,
        },
        Category {
            json_key: "providerStream",
            text_label: "Provider Stream",
            cases: &suite.provider_stream_cases,
        },
        Category {
